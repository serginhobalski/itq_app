        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-white text-center bg-primary">
                    <h3>{{ __('CADASTRAR ATIVIDADE') }}</h3>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('atividades.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <label for="imagem">Imagem da Atividade</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{route('atividades.index')}}" class="btn btn-dark">
