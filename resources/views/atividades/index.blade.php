...
<div class="container">
    <a href="{{url('adm/atividades/create')}}" class="btn mb-2 mt-4">
        <i class="fa fa-save"></i> Cadastrar Atividade
    </a>
        ...
        <table id="ajaxTableRelatorios" class="table" style="width: 100%;">
            <thead>
                <tr>
                    ...
                    <th class="text-primary">ID da Disciplina</th>
                </tr>
            </thead>
