            ...
            <div class="email-wrapper">
                ...
                <div class="mail-list-container">
                    ...
                    <div class="mail-box-list">
                        @foreach ($msg_recebidas as $mensagem)
                        <div class="mail-list-info">
                            ...
                            <ul class="mailbox-toolbar">
                                <li data-toggle="tooltip" title="Deletar">
                                    ...
                                    <a href=""
                                    {{-- href="{{route('mensagens.destroy', $mensagem->principal_id)}}" --}}
                                    onclick="event.preventDefault();
                                        document.getElementById('delete-form').submit();" >
                                        <i class="fa-solid fa-trash text-danger"></i>
                                    </a>
                                    <form id="delete-form" action="{{route('mensagens.destroy', $mensagem->principal_id)}}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </li>
