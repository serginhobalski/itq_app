...
<div class="container">
    <a href="{{url('adm/usuarios/create')}}" class="btn mb-2 mt-4">
        <i class="fa fa-save"></i> Cadastrar Usuário
    </a>
    <a href="{{url('adm/usuarios_xlsx')}}" class="btn mb-2 mt-4">
        <i class="fa fa-file-excel"></i> Exportar XLSX
    </a>
    <a href="{{url('adm/usuarios_csv')}}" class="btn mb-2 mt-4">
        <i class="fa fa-file-text"></i> Exportar CSV
    </a>
...
<script>
    ...
    $(document).ready(function() {
        $('#ajaxTableRelatorios').DataTable({
            ...
            ajax: "{{url('adm/recupera_usuarios')}}",
            columns: [{
                    data: 'id'
                },
                {
