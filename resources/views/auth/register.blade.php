                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('Nome de usuário') }}" required autocomplete="username">
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="image" class="form-control @error('image') is-invalid @enderror"  type="file" name="image" id="" value="{{ old('Image') }}" required autocomplete="image">
